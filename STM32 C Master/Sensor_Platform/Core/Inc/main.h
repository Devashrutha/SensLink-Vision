...
#define SD_CARD_BUTTON_Pin GPIO_PIN_3
#define SD_CARD_BUTTON_GPIO_Port GPIOA
#define SD_CARD_BUTTON_EXTI_IRQn EXTI3_IRQn
...
#define BARO_INT_EXTI_IRQn EXTI1_IRQn
