...
typedef struct {
  ...
  double Ay_Mapped;
  double Az_Mapped;
  double Ax_Mapped_Filtered;
  double Ay_Mapped_Filtered;
  double Az_Mapped_Filtered;
  double Accel[3];
  ...
  double Gy_Mapped;
  double Gz_Mapped;
  double Gx_Mapped_Filtered;
  double Gy_Mapped_Filtered;
  double Gz_Mapped_Filtered;
  double Gyro[3];
...
/* Global Variables ----------------------------------------------------------*/
    // Current configuration of MPU6050 //
...
void MPU6050_Read_UF_GA(MPU6050_t *DataStruct);
